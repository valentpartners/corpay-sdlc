...
- **In-scope small fix** — pair with Codex in this chat; commit; push to the story branch. Hot-reload picks up the change. Loop back to step 4 with the affected flows re-verified.
