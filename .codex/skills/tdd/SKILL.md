---
name: tdd
description: Test-driven development. Red-green-refactor. Tracer-bullet test-first development. Integration-style tests over implementation-detail tests.
---
...
**Good tests** are integration-style: they exercise real code paths through public APIs. They describe _what_ the system does, not _how_ it does it. A good test reads like a specification — the test name names a capability of the system in domain terms. These tests survive refactors because they don't care about internal structure.
