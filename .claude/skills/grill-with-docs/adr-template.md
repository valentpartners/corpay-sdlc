...
Body shape for ADRs at `.claude/knowledge/adrs/NNNN-{slug}.md`. Numbered sequentially, never renumbered. Omit empty sections.
...
- **Number sequentially.** Next ADR number = `ls .claude/knowledge/adrs/ | wc -l` + 1, zero-padded to 4 digits.
