...
- [`shared/ai-disclaimer.md`](../../knowledge/shared/ai-disclaimer.md) — leads the sealed doc.
...
Write `docs/ai-runs/{slug}/qa-handoff.md`. Lead with the [AI disclaimer](../../knowledge/shared/ai-disclaimer.md) line.
...
- The doc leads with the AI disclaimer line.
